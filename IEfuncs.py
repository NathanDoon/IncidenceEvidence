'''
----Incidence & Evidence Functions----
This document contains the block of functions required to repeat the experiment in the 'Incidence and Evidence' paper.

The functions herein come from an early attempt (2022) at creating stylometry tools -- and many have since been improved.
While this code should accurately help you re-creatw and reproduce the experiments in the paper, some of the other arguments included here (such as niche KNN distances) may not be functional.
